  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col h-[500px]">
      <div className="bg-indigo-600 px-6 py-4 flex items-center justify-between">
        ...
        <span className="text-indigo-200 text-xs font-medium">Contexto Ativo</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50/50">
        {messages.length === 0 && (
          <div className="h-full flex flex-col items-center justify-center text-center px-10">
            ...
            <p className="text-gray-500 font-medium">Tire dúvidas sobre este atendimento ou solicite esclarecimentos jurídicos específicos.</p>
          </div>
        )}
